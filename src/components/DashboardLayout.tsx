    ...
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <aside className={cn(
        ...
        <div className="flex h-16 items-center gap-3 border-b border-sidebar-border px-5">
          ...
          <div>
            <h1 className="text-sm font-bold text-sidebar-primary-foreground">AI ClinicPro 🇵🇰</h1>
            <p className="text-[10px] text-sidebar-muted">Smart Clinic Management</p>
          </div>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <footer className="border-t border-border bg-card px-4 py-2 text-center text-xs text-muted-foreground">
          Developed by <span className="font-semibold text-primary">Hamza Ahmed Shaikh</span> • AI ClinicPro 🇵🇰
        </footer>
      </div>
    </div>
  );
